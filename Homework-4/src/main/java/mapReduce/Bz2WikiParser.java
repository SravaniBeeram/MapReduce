...
public class Bz2WikiParser {
    ...
    public static  String parse(String line) throws Exception {
        ...
        // Parser fills this set with linked page names.
        ...
        if(linkPageNames.contains(pageName)){
            ...
            int i= linkPageNames.indexOf(pageName);
            linkPageNames.remove(i);

        }

        return (pageName + "SB" +format(linkPageNames));

    }

    private static String format(List<String> linkPageNames) {

        StringBuilder list = new StringBuilder();

        if(linkPageNames != null) {

            list.append(String.join("~", linkPageNames));
